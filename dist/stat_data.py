...
connection_stats = [
    ...
    CacheStat('cache_eviction_average_page_size', 'xx avg page size at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_average_page_size_sum', 'xx sum for avg page size at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_average_page_size_count', 'xx count for avg page size at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_a', 'xx point a', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_b', 'xx point b', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_c', 'xx point c', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_d', 'xx point d', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_e', 'xx point e', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_f', 'xx point f', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_point_forced', 'xx point forced', 'no_clear,no_scale,size'),
